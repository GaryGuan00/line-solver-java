...
public class LCFSPreBuffer extends StateCell {
    ...
    public LCFSPreBuffer(int nClasses, int nServers, PhaseList phaseList) {
    ...
    public LCFSPreBuffer(int nClasses, int nServers) {
    ...
    public StateCell createCopy() {
        LCFSPreBuffer copyBuffer = new LCFSPreBuffer(this.inQueue.length, this.nServers, this.phaseList.createCopy());
