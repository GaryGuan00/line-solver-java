...
public class GettingStartedSolverFluidSmoothing {
  ...
  public static void main(String[] args) {
    ...
    JLineMatrix targetQueueLengths = searcher.generateTargetQueueLengths(model);
    ...
    JLineMatrix QNFluidWithoutSmoothing = solverFluidWithoutSmoothing.result.QN;
    double errorValue = 0;
    ...
    JLineMatrix QNFluidWithSmoothing = solverFluidWithSmoothing.result.QN;
