...
class PFQNTest {
    ...
    void pfqn_caTest1() {
        ...
        Z.set(1, 1, 0.1);
        Z.set(1, 2, 0.0);
        PFQN.pfqnCAReturn ret = PFQN.pfqn_ca(L, N, Z);
        assertEquals(-6.643789733147672, ret.lGn, tolerance);
        assertEquals(0.001302083333333, ret.Gn, tolerance);
    }
    ...
    void pfqn_caTest2() {
        ...
        Z.set(1, 2, 0.0);
        PFQN.pfqnCAReturn ret = PFQN.pfqn_ca(L, N, Z);
        assertEquals(Double.NEGATIVE_INFINITY, ret.lGn, tolerance);
        assertEquals(0.0, ret.Gn, tolerance);
    }
    ...
    void pfqn_caTest3() {
        ...
        Z.set(1, 2, 0.0);
        PFQN.pfqnCAReturn ret = PFQN.pfqn_ca(L, N, Z);
        assertEquals(0.0, ret.lGn, tolerance);
        assertEquals(1.0, ret.Gn, tolerance);
    }
    ...
    void pfqn_caTest4() {
        ...
        Z.set(1, 2, 0.0);
        PFQN.pfqnCAReturn ret = PFQN.pfqn_ca(L, N, Z);
        assertEquals(-4.037788879321289, ret.lGn, tolerance);
        assertEquals(0.017636425600000, ret.Gn, tolerance);
    }
    ...
    void pfqn_mmint2_gausslegendreTest1() {
        ...
        Z.set(0, 1, 0.3);
        Z.set(0, 2, 1.2);
        PFQN.pfqnMmint2GausslegendreReturn ret = PFQN.pfqn_mmint2_gausslegendre(L, N, Z, m);
    ...
    void pfqn_leTest1() {
        ...
        Z.set(0, 1, 3.214);
        Z.set(0, 2, 55.221);
        PFQN.pfqnLeReturn ret = PFQN.pfqn_le(L, N, Z);
        assertEquals(7.265624088932120e-08, ret.Gn, 7.265624088932120e-08*tolerance);
        assertEquals(  -16.437526547118978, ret.lGn, tolerance);
    }
    ...
    void pfqn_leTest2() {
        ...
        N.set(0, 2, 1);
        PFQN.pfqnLeReturn ret = PFQN.pfqn_le(L, N, Z);
        assertEquals(7.005301586504859e+07, ret.Gn, 7.005301586504859e+07*tolerance);
        assertEquals(  18.064762882854776, ret.lGn, tolerance);
    }
    ...
    void pfqn_leTest3() {
        ...
        Z.set(0, 2, 9.20195);
        PFQN.pfqnLeReturn ret = PFQN.pfqn_le(L, N, Z);
        assertEquals(3.598124832428049e+08, ret.Gn, 3.598124832428049e+08*tolerance);
        assertEquals(    19.701093573828281, ret.lGn, tolerance);
    }
    ...
    void pfqn_leTest4() {
        ...
        Z.set(0, 0, 5.533);
        PFQN.pfqnLeReturn ret = PFQN.pfqn_le(L, N, Z);
        assertEquals(6.532800848885124e+04, ret.Gn, 6.532800848885124e+04*tolerance);
        assertEquals(    11.087176143501352, ret.lGn, tolerance);
    }
    ...
    void pfqn_nc_sanitizeTest1() {
        ...
        double atol = 0.15;
        PFQN.pfqnNcSanitizeReturn ret = PFQN.pfqn_nc_sanitize(lambda, L, N, Z, atol);
    ...
    void pfqn_comomrmTest1() {
        ...
        int m = 1;
        double atol = 0.2;
        PFQN.pfqnComomrmReturn ret = pfqn_comomrm(L, N, Z, m, atol);
        double lG = ret.lG;
    ...
    void compute_norm_constTest1() {
        ...
        Z.set(0, 1, 0.333);
        Z.set(0, 2, 0.1986);
        computeNormConstReturn ret = compute_norm_const(L,N,Z,options);
    ...
    void pfqn_ncTest1() {
        ...
        Z.set(0, 1, 0.3);
        Z.set(0, 2, 0.1);
        pfqnNcReturn ret = pfqn_nc(lambda, L, N, Z, options);
    ...
    void pfqn_gldTest1() {
        ...
        mu.set(3, 4, 2.0);
        mu.set(3, 5, 4.198765);
        pfqnGldReturn ret = pfqn_gld(L,N,mu,null);
    ...
    void compute_norm_const_ldTest1() {
        ...
        mu.set(1, 1, 1);
        mu.set(1, 2, 1);
        computeNormConstLDReturn ret = compute_norm_const_ld(L,N,Z,mu,options);
    ...
    void pfqn_ncldTest1() {
        ...
        mu.set(1, 1, 1);
        mu.set(1, 2, 1);
        pfqnNcldReturn ret = pfqn_ncld(L,N,Z,mu,options);
    ...
    void pfqn_mvaTest1() {
        ...
        PFQN.pfqnMVAReturn ret = PFQN.pfqn_mva(L, N, Z, mi);
    ...
    void pfqn_mvaldmx_ecTest1(){
        ...
        * */
        PFQN.pfqnMVALDMXECReturn ret =  pfqn_mvaldmx_ec(lambda, D, mu);
    ...
    void pfqn_mvaldmxTest1(){
        ...
        S.set(1,0,1);
        PFQN.pfqnMVALDMXReturn ret = pfqn_mvaldmx(lambda, D, N, Z, mu, S);
    ...
    void pfqn_mvaldmsTest1(){
        ...
        PFQN.pfqnMVALDMSReturn ret = pfqn_mvaldms(lambda, D, N, Z, S);
    ...
    void pfqn_mvamxTest1(){
        ...
        Matrix mi = new Matrix(1,1);
        mi.set(0,0,1);
        pfqnMVAMXReturn ret = pfqn_mvamx(lambda, D, N, Z, mi);
    ...
    void pfqn_mvamsTest1(){
        ...
        pfqnMVAMSReturn ret = pfqn_mvams(lambda, L, N, Z, mi, S);
        ...
        assertEquals(13.342678933707491, ret.lG, tolerance);
    }
    ...
    void pfqn_mvamsTest2(){
        ...
        assertEquals(-2.349815629247493, ret.lG, tolerance);
    }
