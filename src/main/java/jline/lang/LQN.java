...
public class LQN {
    ...
    protected Map<Integer, List<Integer>> tasksof;
    ...
    protected JLineMatrix actpre;
    protected JLineMatrix actpost;
    protected int ncalls;
    protected JLineMatrix isref;
