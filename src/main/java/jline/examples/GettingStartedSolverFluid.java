...
public class GettingStartedSolverFluid {
  ...
  public static void main(String[] args) {
    ...
    solver.getAvgTable();
    System.out.format(
        "Fluid analysis (method: %s) completed. Runtime: %f seconds.\n",
        solver.result.method, solver.result.runtime);
  }
  ...
  public static Network closed_ex2() {
    ...
    // Block 3: topology
    model.link(model.serialRouting(delay1, queue1, delay2, queue2));
  ...
  public static Network closed_ex3() {
    ...
    // Block 3: topology
    model.link(model.serialRouting(delay1, queue1, delay2, queue2, delay3, queue3, delay4, queue4));
  ...
  public static Network closed_ex7() {
    ...
    // Block 3: topology
    model.link(model.serialRouting(queue1, queue2, queue3, queue4));
  ...
  public static Network open_ex2() {
    ...
    // Block 3: topology
    model.link(model.serialRouting(source, queue1, queue2, queue3, queue4, sink));
  ...
  public static Network open_ex7() {
    ...
    // Block 3: topology
    model.link(model.serialRouting(source, queue1, sink));
  ...
  public static Network ex1() {
    ...
    RoutingMatrix routingMatrix =
        new RoutingMatrix(
            model,
            Arrays.asList(class1),
            Arrays.asList(source, queue1, queue2, queue3, queue4, sink));
    routingMatrix.addConnection(source, queue1, class1, 0.3);
    routingMatrix.addConnection(source, queue2, class1, 0.2);
    routingMatrix.addConnection(source, queue3, class1, 0.3);
    routingMatrix.addConnection(source, queue4, class1, 0.2);
    routingMatrix.addConnection(queue1, sink, class1, 1);
    routingMatrix.addConnection(queue2, sink, class1, 1);
    routingMatrix.addConnection(queue3, sink, class1, 1);
    routingMatrix.addConnection(queue4, sink, class1, 1);
  ...
  public static Network ex2() {
    ...
    routingMatrix.addConnection(source, queue1, class1, class1, 1);
    routingMatrix.addConnection(queue1, queue2, class1, class1, 1);
    routingMatrix.addConnection(queue2, queue1, class1, class3, 0.2);
    routingMatrix.addConnection(queue2, queue3, class1, class1, 0.8);
    routingMatrix.addConnection(queue3, sink, class1, class1, 1);

    routingMatrix.addConnection(source, queue1, class2, class2, 1);
    routingMatrix.addConnection(queue1, queue2, class2, class2, 1);
    routingMatrix.addConnection(queue2, queue1, class2, class3, 0.2);
    routingMatrix.addConnection(queue2, queue3, class2, class2, 0.8);
    routingMatrix.addConnection(queue3, sink, class2, class2, 1);

    routingMatrix.addConnection(source, queue1, class3, class3, 1);
    routingMatrix.addConnection(queue1, queue2, class3, class3, 1);
    routingMatrix.addConnection(queue2, queue1, class3, class3, 0.2);
    routingMatrix.addConnection(queue2, queue3, class3, class3, 0.8);
    routingMatrix.addConnection(queue3, sink, class3, class3, 1);
