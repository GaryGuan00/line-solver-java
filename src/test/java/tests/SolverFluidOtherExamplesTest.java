...
public class SolverFluidOtherExamplesTest {
  ...
  public void gettingStartedExample7ReturnsCorrectResultFromRunAnalyzer() {
    ...
    SolverFluid solverFluid = new SolverFluid(model);
  ...
  public void exampleCdfRespT2ReturnsCorrectResultFromRunAnalyzerDefaultMethod() {
    ...
    routingMatrix.addConnection(delay, queue, closedClass1, closedClass1, 1.0);
    routingMatrix.addConnection(delay, queue, closedClass2, closedClass2, 1.0);
    routingMatrix.addConnection(queue, delay, closedClass1, closedClass2, 1.0);
    routingMatrix.addConnection(queue, delay, closedClass2, closedClass1, 1.0);
