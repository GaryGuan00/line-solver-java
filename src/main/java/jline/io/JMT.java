...
public class JMT {
    ...
    public static String jmtGetPath() {
        String jmtPath = Paths.get(Objects.requireNonNull(getRootFolder()), "/JMT.jar").toString();
        ...
        if (!jmtFile.exists()) {
            ...
            if (m.equalsIgnoreCase("Y")) {
                ...
                System.out.println("Java Modelling Tools was not found. Please download https://sourceforge.net/projects/jmt/files/jmt/JMT-1.2.4/JMT-singlejar-1.2.4.jar/download and put it under \"src/main/java/jline/solvers/jmt/\".\n");
            }
        }
        return jmtPath;
    }
    ...
    public static String getRootFolder() {
        try {
            URI uri = JMT.class.getProtectionDomain().getCodeSource().getLocation().toURI();
