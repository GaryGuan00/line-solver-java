...
class SIROClassBufferTest {
    private SIROClassBuffer classBuffer;
    ...
    void setUp() {
        ...
        this.nClasses = this.random.nextInt(100)+1;
        this.nServers = this.random.nextInt(100)+1;
        this.nRuns = 200;
        this.maxBatch = 15;
        ...
        this.classBuffer = new SIROClassBuffer(this.random, nClasses,this.nServers, new PhaseList(nPhases,nClasses,this.random));
    }
