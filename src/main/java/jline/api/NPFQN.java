...
public class NPFQN {
    ...
    public static Map<Integer, Matrix> npfqn_traffic_merge(Map<Integer,Map<Integer,Matrix>> MMAP, String config_merge_, String config_compress_){
    ...
    public static Map<Integer,Matrix> npfqn_traffic_merge_cs(Map<Integer,Map<Integer,Matrix>> MMAP,  Matrix prob, String config){
        int n = MMAP.size();
        int R = prob.numCols;
        Map<Integer,Map<Integer,Matrix>> MMAP_copy = new HashMap<>();
        for (Map.Entry<Integer, Map<Integer, Matrix>> entry : MMAP.entrySet()) {
    ...
    public static Map<Integer,Matrix> npfqn_traffic_merge_cs(Map<Integer,Map<Integer,Matrix>> MMAP,  Matrix prob){
        return npfqn_traffic_merge_cs(MMAP,prob,"default");
    }
