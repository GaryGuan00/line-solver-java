...
public class LCFSNonPreBuffer extends StateCell {
    /*
    ...
    public LCFSNonPreBuffer(int nClasses, int nServers, PhaseList phaseList) {
    ...
    public LCFSNonPreBuffer(int nClasses, int nServers) {
    ...
    public StateCell createCopy() {
        LCFSNonPreBuffer copyBuffer = new LCFSNonPreBuffer(this.inQueue.length, this.nServers, this.phaseList.createCopy());
