        ...
        switch(options.method){
            case "aba.upper":
                if(sn.nclasses == 1 && sn.nclosedjobs > 0){
                    ...
                    CN.set(0,0,Z + N * Dsum);
                    XN = new Matrix(1,1);
                    XN.set(0,0, UTIL.min(1/Dmax, N / (Z + Dsum)));
            ...
            case "bjb.upper":
                if(sn.nclasses == 1 && sn.nclosedjobs > 0){
                    ...
                    double Xaba_upper_1 = UTIL.min(1/Dmax, (N - 1)/(Z + Dsum));
                    double Xaba_lower_1 = (N - 1)/(Z + (N - 1) * Dsum);

                    CN = new Matrix(1,1);
                    CN.set(0,0,Z + Dsum + Dmax * (N - 1 - Z * Xaba_lower_1));
                    XN = new Matrix(1,1);
                    XN.set(0,0, UTIL.min(1/Dmax, N / (Z + Dsum + D.meanCol().get(0,0) * (N - 1 - Z * Xaba_upper_1))));
                    TN = new Matrix(V.getNumRows(), 1);
                    for(int i = 0; i < V.getNumRows(); i++){
                        TN.set(i, 0, V.get(i, 0) * XN.get(0,0));
                    }
            ...
            case "pb.upper":
                if(sn.nclasses == 1 && sn.nclosedjobs > 0){
                    ...
                    XN = new Matrix(1,1);
                    XN.set(0,0, UTIL.min(1/Dmax, N / (Z + Dsum + Dpb2 * (N - 1 - Z * Xaba_upper_1))));
                    TN = new Matrix(V.getNumRows(), 1);
                    for(int i = 0; i < V.getNumRows(); i++){
                        TN.set(i, 0, V.get(i, 0) * XN.get(0,0));
                    }
            ...
            case "sb.upper":
                if(sn.nclasses == 1 && sn.nclosedjobs > 0){
                    ...
                    XN = new Matrix(1,1);
                    XN.set(0,0,UTIL.min(1/Dmax, N / CN.get(0,0)));
                    TN = new Matrix(V.getNumRows(), 1);
                    for(int i = 0; i < V.getNumRows(); i++){
                        TN.set(i, 0, V.get(i, 0) * XN.get(0,0));
                    }
            ...
            case "gb.upper":
                if(sn.nclasses == 1 && sn.nclosedjobs > 0){
                    ...
                    double Dmax = D.elementMax();
                    XN = new Matrix(1,1);
                    XN.set(0,0, UTIL.min(1/Dmax, pfqn_xzgsbup(D, N, Z)));
