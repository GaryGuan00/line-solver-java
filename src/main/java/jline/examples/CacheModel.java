...
public class CacheModel {
    ...
    public static Network ex1(){
        ...
        Cache cacheNode = new Cache(model, "Cache", n, m, ReplacementStrategy.FIFO, null);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hit ratio: " + ((Cache) model.getNodes().get(1)).getHitRatio().get(0));
        System.out.println("Miss ratio: " + ((Cache) model.getNodes().get(1)).getMissRatio().get(0));
    }
}
